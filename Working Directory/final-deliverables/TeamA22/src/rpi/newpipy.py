...
Original file is located at
    https://colab.research.google.com/drive/1SyZEPRk89BbcH3Kp32k4HVeS74Vd4oFp
"""
...
# Define blue color ranges for tarp detection
lower_blue = np.array([80, 50, 50])  # Lower bound of the blue color range in HSV
    ...
    while(copter.distance_to_current_waypoint(command.x, command.y, command.z) > float(position_buffer)):
        ...
        if targets:
            for target_x, target_y in targets:
                ...
                # create a packet with all relevant information for the GCS
                packet = {
